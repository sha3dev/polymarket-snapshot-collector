...
const config = {
  ...
  CLICKHOUSE_LEGACY_SNAPSHOT_TABLE: ENV.CLICKHOUSE_LEGACY_SNAPSHOT_TABLE || "snapshot",
  CLICKHOUSE_SNAPSHOT_TABLE: ENV.CLICKHOUSE_SNAPSHOT_TABLE || "snapshot_v2",
  CLICKHOUSE_MIGRATION_STATE_TABLE: ENV.CLICKHOUSE_MIGRATION_STATE_TABLE || "migration_state",
  SUPPORTED_ASSETS:
