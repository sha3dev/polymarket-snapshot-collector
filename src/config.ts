...
const config = {
  ...
  DASHBOARD_STALE_AFTER_MS: Number(ENV.DASHBOARD_STALE_AFTER_MS || 1000),
  ENABLE_PERF_LOGS: ENV.ENABLE_PERF_LOGS === "true",
  SNAPSHOT_INSERT_BATCH_MAX_SIZE: Number(ENV.SNAPSHOT_INSERT_BATCH_MAX_SIZE || 64),
  SNAPSHOT_INSERT_BATCH_MAX_WAIT_MS: Number(ENV.SNAPSHOT_INSERT_BATCH_MAX_WAIT_MS || 50),
