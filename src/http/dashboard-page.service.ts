  ...
  <body>
    ...
    <script>
      ...
      const renderWidget = (widget) => {
        ...
        const cardStateClass = widget.market ? (widget.isStale ? "is-stale" : "") : "is-empty";
        const badgeClass = widget.marketDirection === "UP" ? "up" : widget.marketDirection === "DOWN" ? "down" : "unknown";
